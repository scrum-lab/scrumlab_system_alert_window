# scrumlab_system_alert_window
[![Pub](https://img.shields.io/pub/v/scrumlab_system_alert_window.svg)](https://pub.dartlang.org/packages/scrumlab_system_alert_window)
...
<img src="https://github.com/scrum-lab/ScrumlabSystemAlertWindow/raw/main/assets/images/example%20demo.gif" width="300" height="570">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="https://github.com/scrum-lab/ScrumlabSystemAlertWindow/raw/main/assets/images/background%20button%20click.gif" width="300" height="570">
...
#### KOTLIN (Application.kt)
      ...
      import `in`.jvapps.scrumlab_system_alert_window.ScrumlabSystemAlertWindowPlugin
      import io.flutter.app.FlutterApplication
      import io.flutter.plugin.common.PluginRegistry
      ...
      class Application : FlutterApplication(), PluginRegistrantCallback {
         ...
         override fun registerWith(registry: PluginRegistry) {
            ScrumlabSystemAlertWindowPlugin.registerWith(registry.registrarFor("br.com.scrumlab.scrumlab_system_alert_window"));
         }
      }
...
### Manifest
      ...
      <uses-permission android:name="android.permission.WAKE_LOCK" />
          ...
          <application
              ...
              android:label="scrumlab_system_alert_window_example"
