package br.com.scrumlab.scrumlab_system_alert_window.utils;
...
import br.com.scrumlab.scrumlab_system_alert_window.models.Decoration;
import br.com.scrumlab.scrumlab_system_alert_window.models.Margin;
import br.com.scrumlab.scrumlab_system_alert_window.models.Padding;

import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.CALLBACK_TYPE_ONCLICK;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_BORDER_COLOR;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_BORDER_RADIUS;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_BORDER_WIDTH;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_BOTTOM;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_DECORATION;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_END_COLOR;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_FONT_SIZE;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_FONT_WEIGHT;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_HEIGHT;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_LEFT;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_MARGIN;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_PADDING;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_RIGHT;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_START_COLOR;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_TAG;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_TEXT;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_TEXT_COLOR;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_TOP;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.KEY_WIDTH;
...
public class UiBuilder {
    ...
    public static Button getButtonView(Context context, Map<String, Object> buttonMap) {
        ...
        button.setOnClickListener(v -> {
            if (!ScrumlabSystemAlertWindowPlugin.sIsIsolateRunning.get()) {
                ScrumlabSystemAlertWindowPlugin.startCallBackHandler(context);
            }
            ScrumlabSystemAlertWindowPlugin.invokeCallBack(context, CALLBACK_TYPE_ONCLICK, tag);
        });
        return button;
    }
