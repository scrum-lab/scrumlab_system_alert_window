...
public class Constants {
    ...
    public static final String CHANNEL = "br.com.scrumlab.scrumlab_system_alert_window";
    public static final String BACKGROUND_CHANNEL = "br.com.scrumlab.scrumlab_system_alert_window/background";

    public static final String SHARED_PREF_SYSTEM_ALERT_WINDOW = "br.com.scrumlab.scrumlab_system_alert_window";
