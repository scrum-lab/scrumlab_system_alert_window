package br.com.scrumlab.scrumlab_system_alert_window;
...
import br.com.scrumlab.scrumlab_system_alert_window.services.WindowServiceNew;
import br.com.scrumlab.scrumlab_system_alert_window.utils.Commons;
import br.com.scrumlab.scrumlab_system_alert_window.utils.Constants;
import br.com.scrumlab.scrumlab_system_alert_window.utils.NotificationHelper;
...
import static br.com.scrumlab.scrumlab_system_alert_window.services.WindowServiceNew.INTENT_EXTRA_IS_CLOSE_WINDOW;
import static br.com.scrumlab.scrumlab_system_alert_window.services.WindowServiceNew.INTENT_EXTRA_IS_UPDATE_WINDOW;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.CHANNEL;
import static br.com.scrumlab.scrumlab_system_alert_window.utils.Constants.INTENT_EXTRA_PARAMS_MAP;

public class ScrumlabSystemAlertWindowPlugin extends Activity implements MethodCallHandler {
    ...
    private static String TAG = "ScrumlabSystemAlertWindowPlugin";

    @SuppressWarnings("unused")
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), CHANNEL);
        channel.setMethodCallHandler(new ScrumlabSystemAlertWindowPlugin(registrar.context(), registrar.activity(), channel));
    }

    private ScrumlabSystemAlertWindowPlugin(Context context, Activity activity, MethodChannel newMethodChannel) {
